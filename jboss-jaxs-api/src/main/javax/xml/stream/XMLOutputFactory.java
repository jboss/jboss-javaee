...
public abstract class XMLOutputFactory
{
   ...
   {
      return (XMLOutputFactory) FactoryLocator.find(XML_OUTPUT_FACTORY_KEY, XML_OUTPUT_FACTORY_DEFAULT);
   }
   ...
   {
      return (XMLInputFactory) FactoryLocator.find(factoryId, XML_OUTPUT_FACTORY_DEFAULT, classLoader);
   }
