 ...
 * well formed. Each NAMESPACE and ATTRIBUTE must be individually written.
 *
 * <p>
 * If javax.xml.stream.isPrefixDefaulting is set to false it is a fatal error if
 * an element is written with namespace URI that has not been bound to a prefix.
 *
 * <p>
 * If javax.xml.stream.isPrefixDefaulting is set to true the XMLStreamWriter
...
public interface XMLStreamWriter
{
    ...
    *
    * @param context the namespace context to use for this writer, may not be
    * null
    * @throws XMLStreamException
    */
    ...
    * prefix and javax.xml.stream.isPrefixDefaulting has not been set to true
    */
    ...
    *
    * @param target the target of the processing instruction, may not be null
    * @param data the data contained in the processing instruction, may not be
    * null
    * @throws XMLStreamException
    */
