...
public abstract class XMLEventFactory
{
   ...
   {
      return (XMLEventFactory) FactoryLocator.find(XML_EVENT_FACTORY_KEY, XML_EVENT_FACTORY_DEFAULT);
   }
   ...
   {
      return (XMLEventFactory) FactoryLocator.find(factoryId, XML_EVENT_FACTORY_DEFAULT, classLoader);
   }
    ...
    * @param namespaceURI the attribute value is set to this value, may not be
    * null
    * @param localName the local name of the XML name of the attribute,
    ...
    *
    * @param name the qualified name of the attribute, may not be null
    * @param attributes an optional unordered set of objects that implement
    * Attribute to add to the new StartElement, may be null
    * @param namespaces an optional unordered set of objects that implement
    ...
    * @param localName the local name of the QName of the new StartElement
    * @param prefix the prefix of the QName of the new StartElement
    * @param attributes an unordered set of objects that implement Attribute to
    * add to the new StartElement
    * @param namespaces an unordered set of objects that implement Namespace to
    * add to the new StartElement
    * @return an instance of the requested StartElement
    */
   public abstract StartElement createStartElement(String prefix, String namespaceUri, String localName, Iterator attributes,
         Iterator namespaces);
    ...
    * @param prefix the prefix of the QName of the new StartElement
    * @param attributes an unordered set of objects that implement Attribute to
    * add to the new StartElement, may be null
    * @param namespaces an unordered set of objects that implement Namespace to
    * add to the new StartElement, may be null
