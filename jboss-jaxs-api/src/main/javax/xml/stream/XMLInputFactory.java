...
public abstract class XMLInputFactory
{
   ...
   {
      return (XMLInputFactory) FactoryLocator.find(XML_INPUT_FACTORY_KEY, XML_INPUT_FACTORY_DEFAULT);
   }
   ...
   {
      return (XMLInputFactory) FactoryLocator.find(factoryId, XML_INPUT_FACTORY_DEFAULT, classLoader);
   }
