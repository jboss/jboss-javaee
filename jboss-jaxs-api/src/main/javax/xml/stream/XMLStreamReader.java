 ...
 * of event just read.
 * <p>
 * The event type can be determined using <a
 * href="#getEventType()">getEventType() </a>.
 * <p>
 ...
 * These properties can only be accessed during a DTD event and are defined to
...
public interface XMLStreamReader extends XMLStreamConstants
{
    ...
    * @throws IllegalStateException if this not a START_ELEMENT, END_ELEMENT or
    * ENTITY_REFERENCE
    */
    ...
    *       break;
    * }
    * </code> XMLStreamException may be thrown if
    ...
    *
    * @param sourceStart the index of the first character in the source array to
    * copy
    ...
    * of target
    * @throws IndexOutOfBoundsException if length < 0 or targetStart + length >
    * length of target
    ...
    * element content or CDATA Sections.
    *
